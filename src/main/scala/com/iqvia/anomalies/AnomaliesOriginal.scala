...
object RunKMeansOriginal {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data = spark.read.
      ...
      option("header", false).
      csv("C:\\Users\\angel.rey\\IdeaProjects\\anomalies\\data\\kddcup.data_10_percent_corrected").
      toDF(
    ...
    val runKMeans = new RunKMeansOriginal(spark)
...
class RunKMeansOriginal(private val spark: SparkSession) {
