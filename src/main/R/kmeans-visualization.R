...
Sys.setenv(SPARK_HOME = "C:/spark-2.4.0-bin-hadoop2.7")
Sys.setenv(JAVA_HOME = "C:/Program Files/Java/jdk1.8.0_131")
library(SparkR, lib.loc = c(file.path(Sys.getenv("SPARK_HOME"), "R", "lib")))

# angel library("SparkR", lib.loc="C:\\spark-2.4.0-bin-hadoop2.7\\R\\lib") # The use of \\ is for windows environment.
...
clusters_data <- read.df("C:/Users/angel.rey/IdeaProjects/anomalies/data/kddcup.data_10_percent_corrected", "csv",
